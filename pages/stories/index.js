  ...
  return (
    <section className="stories big_container desktop:my-44">
      ...
      {stories.map((story) => (
        <div
          key={story.slug}
          className="hover:translate-x-24 trans duration-500"
        >
          <Link href={"/stories/" + story.slug}>
            <a className="group py-16 big:py-24 inline-flex items-end trans relative">
              ...
              <div className="absolute trans bottom-0 hover:-left-4 left-0 group-hover:translate-x-[16rem] group-hover:right-0 invisible group-hover:visible z-0">
                <figure className="relative w-104 h-80">
                  <Image
